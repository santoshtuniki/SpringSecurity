...
<body>
	...
	<div class="container">
		...
		<form action="/LibraryManagement/books/search" class="form-inline">
			<!-- Add a button -->
			<a href="/LibraryManagement/books/showFormForAdd" class="btn btn-primary btn-sm mb-3">
			 	Add Book 
			</a> 
			...
			<a href="/LibraryManagement/logout" class="btn btn-primary btn-sm mb-3 mx-auto">
				Logout 
			</a>
		</form>
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							<a href="/LibraryManagement/books/showFormForUpdate?bookId=${tempBook.id}" class="btn btn-info btn-sm">
								Update 
							</a> 
							<!-- Add "delete" button/link -->
							<a href="/LibraryManagement/books/delete?bookId=${tempBook.id}" class="btn btn-danger btn-sm" 
